...
from ThreeWToolkit.feature_extraction.exponential_statistics import EWStatisticalConfig, _AVAILABLE_FEATURES
...
class TestExtractStatisticalFeatures:
    ...
    def test_ew_stats_with_windowing(self, simple_dataset, window_size, features, decay):
        ...
        feature_extractor = SequentialFeatureAdapterConfig(
            steps=[
                ...
                EWStatisticalConfig(window_size=window_size, decay=decay, features=features),
            ]
        ).build()
