...
class TestInstantiable:
    ...
    def test_build_with_extra_args(self) -> None:
        """Test build pattern passing extra arguments."""

        class MyClass:
            def __init__(self, config, extra_arg) -> None:
                self.value = config.value
    ...
    def test_build_with_kwargs(self) -> None:
        ...
        class MyClass:
            def __init__(self, config, *, name: str = "default") -> None:
    ...
    def test_config_accessible_in_built_instance(self) -> None:
    ...
    def test_nested_config_instantiation(self) -> None:
        ...
        class InnerConfig(BaseModel, Instantiable):
            inner_value: int
            _target: type[InnerClass] = InnerClass
        ...
        class OuterConfig(BaseModel, Instantiable):
            ...
            _target: type[OuterClass] = OuterClass
