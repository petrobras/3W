...
<img width="1200" src="../docs/figures/3w_top_view.png">
...
<img width="1200" src="../docs/figures/3w_data_loader.png">
...
<img width="1200" src="../docs/figures/3w_model_dev.png">
...
<img width="1200" src="../docs/figures/3w_assessment.png">
...
The 3WToolkit examples can be found <a href="../docs/examples">here</a>
...
The 3WToolkit demos can be found <a href="../docs/examples">here</a> (TO BE DONE!)
...
The 3WToolkit challenges can be found <a href="../docs/examples">here</a> (TO BE DONE!)
...
The 3WToolkit videos can be found <a href="../docs/examples">here</a> (TO BE DONE!)
...
<img width="1200" src="../docs/figures/3w_toolkit_uml.png">
...
<img width="1200" src="../docs/figures/docker-logo-blue.png">
