...
class StableLSTMAutoencoder:
    ...
    def build_model(self):
        ...
        decoded = TimeDistributed(Dense(self.n_features, 
                                      kernel_initializer=GlorotUniform(seed=42),
                                      activation='sigmoid'),  # Sigmoid to match data range
                                name='output')(decoded)
        ...
        self.model.compile(
            optimizer=Adam(learning_rate=0.0005,   # Conservative learning rate
